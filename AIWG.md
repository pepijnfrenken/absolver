...
<!-- Regenerate with: aiwg hook-regenerate -->
<!-- Disable with: aiwg hook-disable -->
...
- **34 specialized agents** covering all lifecycle phases (Inception → Elaboration → Construction → Transition → Production)
- **3 skills** for project management, security, testing, deployment, and traceability
